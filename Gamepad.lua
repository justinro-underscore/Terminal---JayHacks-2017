...
function Gamepad:update()
  ...
  if math.abs(self.source:getGamepadAxis("leftx")) > .15 or math.abs(self.source:getGamepadAxis("lefty")) > .15 then
  ...
  if math.abs(self.source:getGamepadAxis("rightx")) > .15 or math.abs(self.source:getGamepadAxis("righty")) > .15 then
